...
uses
  ...
  Vcl.ComCtrls, Vcl.Buttons, Vcl.Mask, Vcl.ExtCtrls, JPeg, Vcl.ExtDlgs,
   ACBrBase, ACBrEnterTab, ACBrSocket, ACBrCEP,
  ACBrValidador, Vcl.Grids, Vcl.DBGrids, MemDS, DBAccess, Uni;
...
type
  TfrmCadPessoa = class(TForm)
    ...
    Label27: TLabel;
    DBComboBoxEh2: TDBComboBox;
    Label33: TLabel;
    DBComboBoxEh3: TDBComboBox;
    DBEdit26: TDBEdit;
    Label35: TLabel;
    Label30: TLabel;
    Panel4: TPanel;
